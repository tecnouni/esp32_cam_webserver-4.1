...
<html>
          ...
          <input type="checkbox" id="nav-toggle-cb" checked="checked">
            <nav id="menu">
              ...
              <div class="input-group" id="cam_name-group">
                <label for="cam_name">
                <a href="/dump" title="System Info" target="_blank">Informaci&oacute;n</a></label>
              ...
              <div class="input-group" id="code_ver-group">
                ...
                <a href="https://github.com/easytarget/esp32-cam-webserver"
                  title="ESP32 Cam Webserver on GitHub" target="_blank">Original</a></label>
                <div id="code_ver" class="default-action"></div>
              </div>
              <div class="input-group hidden" id="stream-group">
                <label for="stream_url" id="stream_link">V&iacute;deo</label>
  ...
  document.addEventListener('DOMContentLoaded', function (event) {
    ...
    const startStream = () => {
      ...
      streamButton.innerHTML = 'Parar V&iacute;deo';
     // streamButton.setAttribute("title", `Parar V&iacute;deo`);
